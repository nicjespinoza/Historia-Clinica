                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-16 gap-x-8">
                        ...
                        <div className="flex flex-col items-center group">
                            ...
                            <div className="bg-white rounded-3xl p-4 pt-10 pb-8 shadow-2xl w-full h-full flex flex-col border-2 border-black">
                                ...
                                <p className="mt-6 text-black text-center leading-relaxed font-medium px-2">
                        ...
                        <div className="flex flex-col items-center group">
                            <div className="bg-white dark:bg-surface-dark text-black font-bold text-lg md:text-xl px-8 py-3 rounded-2xl border border-gray-300 dark:border-slate-600 shadow-lg mb-[-1.5rem] z-10 w-auto text-center transform group-hover:-translate-y-1 transition-transform duration-300">
                                {t('services.endoscopic_items.1.title')}
                            </div>
                            <div className="bg-white rounded-3xl p-4 pt-10 pb-8 shadow-2xl w-full h-full flex flex-col border-2 border-black">
                                <div className="rounded-2xl overflow-hidden shadow-inner border border-gray-100 dark:border-slate-700">
                                ...
                                <p className="mt-6 text-black text-center leading-relaxed font-medium px-2">
                                    {t('services.endoscopic_items.1.desc')}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center group">
                            <div className="bg-white dark:bg-surface-dark text-black font-bold text-lg md:text-xl px-8 py-3 rounded-2xl border border-gray-300 dark:border-slate-600 shadow-lg mb-[-1.5rem] z-10 w-auto text-center transform group-hover:-translate-y-1 transition-transform duration-300">
                                {t('services.endoscopic_items.2.title')}
                            </div>
                            <div className="bg-white rounded-3xl p-4 pt-10 pb-8 shadow-2xl w-full h-full flex flex-col border-2 border-black">
                                <div className="rounded-2xl overflow-hidden shadow-inner border border-gray-100 dark:border-slate-700">
                                ...
                                <p className="mt-6 text-black text-center leading-relaxed font-medium px-2">
                                    {t('services.endoscopic_items.2.desc')}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center group">
                            <div className="bg-white dark:bg-surface-dark text-black font-bold text-lg md:text-xl px-8 py-3 rounded-2xl border border-gray-300 dark:border-slate-600 shadow-lg mb-[-1.5rem] z-10 w-auto text-center transform group-hover:-translate-y-1 transition-transform duration-300">
                                {t('services.endoscopic_items.3.title')}
                            </div>
                            <div className="bg-white rounded-3xl p-4 pt-10 pb-8 shadow-2xl w-full h-full flex flex-col border-2 border-black">
                                <div className="rounded-2xl overflow-hidden shadow-inner border border-gray-100 dark:border-slate-700">
                                ...
                                <p className="mt-6 text-black text-center leading-relaxed font-medium px-2">
                                    {t('services.endoscopic_items.3.desc')}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center group">
                            <div className="bg-white dark:bg-surface-dark text-black font-bold text-lg md:text-xl px-8 py-3 rounded-2xl border border-gray-300 dark:border-slate-600 shadow-lg mb-[-1.5rem] z-10 w-auto text-center transform group-hover:-translate-y-1 transition-transform duration-300">
                                {t('services.endoscopic_items.4.title')}
                            </div>
                            <div className="bg-white rounded-3xl p-4 pt-10 pb-8 shadow-2xl w-full h-full flex flex-col border-2 border-black">
                                <div className="rounded-2xl overflow-hidden shadow-inner border border-gray-100 dark:border-slate-700">
                                ...
                                <p className="mt-6 text-black text-center leading-relaxed font-medium px-2">
                                    {t('services.endoscopic_items.4.desc')}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center group">
                            <div className="bg-white dark:bg-surface-dark text-black font-bold text-lg md:text-xl px-8 py-3 rounded-2xl border border-gray-300 dark:border-slate-600 shadow-lg mb-[-1.5rem] z-10 w-auto text-center transform group-hover:-translate-y-1 transition-transform duration-300">
                                {t('services.endoscopic_items.5.title')}
                            </div>
                            <div className="bg-white rounded-3xl p-4 pt-10 pb-8 shadow-2xl w-full h-full flex flex-col border-2 border-black">
                                <div className="rounded-2xl overflow-hidden shadow-inner border border-gray-100 dark:border-slate-700">
                                ...
                                <p className="mt-6 text-black text-center leading-relaxed font-medium px-2">
                                    {t('services.endoscopic_items.5.desc')}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center group">
                            <div className="bg-white dark:bg-surface-dark text-black font-bold text-lg md:text-xl px-8 py-3 rounded-2xl border border-gray-300 dark:border-slate-600 shadow-lg mb-[-1.5rem] z-10 w-auto text-center transform group-hover:-translate-y-1 transition-transform duration-300">
                                {t('services.endoscopic_items.6.title')}
                            </div>
                            <div className="bg-white rounded-3xl p-4 pt-10 pb-8 shadow-2xl w-full h-full flex flex-col border-2 border-black">
                                <div className="rounded-2xl overflow-hidden shadow-inner border border-gray-100 dark:border-slate-700">
                                ...
                                <p className="mt-6 text-black text-center leading-relaxed font-medium px-2">
                                    {t('services.endoscopic_items.6.desc')}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center group">
                            <div className="bg-white dark:bg-surface-dark text-black font-bold text-lg md:text-xl px-8 py-3 rounded-2xl border border-gray-300 dark:border-slate-600 shadow-lg mb-[-1.5rem] z-10 w-auto text-center transform group-hover:-translate-y-1 transition-transform duration-300">
                                {t('services.endoscopic_items.7.title')}
                            </div>
                            <div className="bg-white rounded-3xl p-4 pt-10 pb-8 shadow-2xl w-full h-full flex flex-col border-2 border-black">
                                <div className="rounded-2xl overflow-hidden shadow-inner border border-gray-100 dark:border-slate-700">
                                ...
                                <p className="mt-6 text-black text-center leading-relaxed font-medium px-2">
                                    {t('services.endoscopic_items.7.desc')}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center group">
                            <div className="bg-white dark:bg-surface-dark text-black font-bold text-lg md:text-xl px-8 py-3 rounded-2xl border border-gray-300 dark:border-slate-600 shadow-lg mb-[-1.5rem] z-10 w-auto text-center transform group-hover:-translate-y-1 transition-transform duration-300">
                                {t('services.endoscopic_items.8.title')}
                            </div>
                            <div className="bg-white rounded-3xl p-4 pt-10 pb-8 shadow-2xl w-full h-full flex flex-col border-2 border-black">
                                <div className="rounded-2xl overflow-hidden shadow-inner border border-gray-100 dark:border-slate-700">
                                ...
                                <p className="mt-6 text-black text-center leading-relaxed font-medium px-2">
                                    {t('services.endoscopic_items.8.desc')}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center group md:col-start-2">
                            <div className="bg-white dark:bg-surface-dark text-black font-bold text-lg md:text-xl px-8 py-3 rounded-2xl border border-gray-300 dark:border-slate-600 shadow-lg mb-[-1.5rem] z-10 w-auto text-center transform group-hover:-translate-y-1 transition-transform duration-300">
                                {t('services.endoscopic_items.9.title')}
                            </div>
                            <div className="bg-white rounded-3xl p-4 pt-10 pb-8 shadow-2xl w-full h-full flex flex-col border-2 border-black">
                                <div className="rounded-2xl overflow-hidden shadow-inner border border-gray-100 dark:border-slate-700">
                                ...
                                <p className="mt-6 text-black text-center leading-relaxed font-medium px-2">
                                    {t('services.endoscopic_items.9.desc')}
                                </p>
                            </div>
                        </div>
