    ...
    return (
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 flex flex-col h-[600px]">
            ...
            <div className="grid grid-cols-8 border-b border-gray-200 bg-gray-50/50">
                <div className="p-4 border-r border-gray-200 text-center text-xs font-bold text-gray-400 uppercase tracking-wider">
                    Hora
                </div>
                {weekDays.map((day, i) => (
            ...
            <div className="overflow-y-auto flex-1 custom-scrollbar">
                {TIME_SLOTS.map(time => (
                    <div key={time} className="grid grid-cols-8 min-h-[100px] border-b border-gray-100 last:border-none">
                        {/* Time Label */}
                        <div className="p-2 border-r border-gray-100 flex items-start justify-center text-xs font-medium text-gray-400 bg-gray-50/30 sticky left-0">
                            {time}
                        </div>
